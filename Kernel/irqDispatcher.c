...
void * (* sys_call_arr[])(void * rsi, void * rdx, void * rcx, void * r8, void * r9) = {
	read /*0*/, write /*1*/, printRectangle /*2*/, getScreenWidth /*3*/, getScreenHeight /*4*/, 
	printChar /*5*/, wait /*6*/, keyboardStatus /*7*/, keyboardKey /*8*/, beepSyscall /*9*/, 
	fontSizeUp /*10*/, fontSizeDown /*11*/, getTime /*12*/
};
