...
void acquire_sem_lock(semaphore *sem) { acquire(&sem->sem_lock); }

void release_sem_lock(semaphore *sem) { release(&sem->sem_lock); }
...
int8_t get_sem_value(int8_t id) { return semaphores[id].value; }
