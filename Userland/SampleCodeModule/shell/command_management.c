...
void div0(uint8_t argc, char *argv[]) { divZero(); }
...
void help(uint8_t argc, char *argv[]) { printf("%s", helpMsg); }

void invalidOpCode(uint8_t argc, char *argv[]) { opcode(); }
