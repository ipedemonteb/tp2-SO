...
static char *phylo_names[] = {"Alonso",     "Verstappen", "Senna", "Colapinto",
...
int8_t run_phylo() {
  printf("Philosophers problem but with F1 drivers.\nEach driver needs two "
         "pedals to be able to drive.\nPress 'a' to add a driver, 'r' to "
         "remove one or 'q' to quit.\n");
